...
"}")
        ...
        self.StateComboBox.setGeometry(QtCore.QRect(580, 260, 141, 36))
        ...
        self.HomeSearchURLInput.setGeometry(QtCore.QRect(281, 446, 211, 36))
        ...
        self.BlogURLInput.setGeometry(QtCore.QRect(581, 400, 291, 36))
        ...
        self.HomeValueURLInput.setGeometry(QtCore.QRect(501, 446, 221, 36))
        ...
        self.ZipInput.setGeometry(QtCore.QRect(730, 260, 141, 36))
        ...
        self.WebsiteURLInput.setGeometry(QtCore.QRect(281, 400, 291, 36))
        ...
        self.WebLabel.setGeometry(QtCore.QRect(280, 370, 101, 18))
        font = QtGui.QFont()
        ...
        self.BannerImageLabel.setGeometry(QtCore.QRect(890, 430, 191, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(False)
        font.setItalic(False)
        ...
        self.HexColorFrame.setGeometry(QtCore.QRect(731, 446, 141, 36))
...
"}")
        ...
        self.MarketAreaInput = QtWidgets.QLineEdit(self.AddClientPage)
        self.MarketAreaInput.setGeometry(QtCore.QRect(280, 310, 591, 36))
        self.MarketAreaInput.setMinimumSize(QtCore.QSize(0, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.MarketAreaInput.setFont(font)
        self.MarketAreaInput.setText("")
        self.MarketAreaInput.setObjectName("MarketAreaInput")
...
"}")
        ...
        MailBlender.setTabOrder(self.CityInput, self.StateComboBox)
        MailBlender.setTabOrder(self.StateComboBox, self.ZipInput)
        MailBlender.setTabOrder(self.ZipInput, self.MarketAreaInput)
        MailBlender.setTabOrder(self.MarketAreaInput, self.WebsiteURLInput)
        ...
        MailBlender.setTabOrder(self.CancelBtn, self.searchBoxInput)
        MailBlender.setTabOrder(self.searchBoxInput, self.clientListWidget)
    ...
    def retranslateUi(self, MailBlender):
        ...
        self.MarketAreaInput.setPlaceholderText(_translate("MailBlender", "Market Area"))

...
"}")
        ...
        self.lineEdit.setGeometry(QtCore.QRect(6, 30, 255, 38))
        font = QtGui.QFont()
        font.setPointSize(12)
...
"}")
    ...
    def retranslateUi(self, MailBlender):
        ...
        self.Address2Input.setText(_translate("MailBlender", "Suite 202"))
        ...
        self.WebsiteURLInput.setText(_translate("MailBlender", "eyegoop.com"))
